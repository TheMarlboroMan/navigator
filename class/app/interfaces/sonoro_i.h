...
class Sonoro_I
{
	...
	void						insertar_reproducir(const App_Audio::Audio_reproducir& a) {reproducir.push_back(a);}
	...
	std::vector<App_Audio::Audio_reproducir>&	acc_reproducir() {return reproducir;}
	...
	std::vector<App_Audio::Audio_reproducir>	reproducir;
