...
void Conversor_facetas_objeto_juego::extraer_borrables(const std::vector<std::shared_ptr<Objeto_juego_I> > v, std::vector<const Borrable_I *>& resultado)
{
	class V:public Visitante_objeto_juego
	{
		private:
		typedef std::vector<const Borrable_I *> t_res;
		t_res& v;
